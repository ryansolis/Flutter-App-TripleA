  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: <String, WidgetBuilder>{
        '/StudentBulletinBoard': (BuildContext context) =>
            new StudentBulletinBoard(),
        '/AdminBulletinBoard': (BuildContext context) =>
            new AdminBulletinBoard(),
        '/PersonnelBulletinBoard': (BuildContext context) =>
            new PersonnelBulletinBoard(),
